...
|---|---|---|
| `ts/` | @voxgig-sdk/json-ip-geolocation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/json-ip-geolocation-sdk \
      --repository voxgig-sdk/json-ip-geolocation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/json-ip-geolocation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/json-ip-geolocation-sdk --id=<id>` removes it.
