...
// JsonIpGeolocation SDK metrics feature
...
class JsonIpGeolocationMetricsFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _record(JsonIpGeolocationContext $ctx, bool $ok): void
    {
