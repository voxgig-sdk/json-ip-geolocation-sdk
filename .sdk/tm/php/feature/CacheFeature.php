...
// JsonIpGeolocation SDK cache feature
...
class JsonIpGeolocationCacheFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _through(JsonIpGeolocationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
