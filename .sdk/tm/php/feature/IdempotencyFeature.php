...
// JsonIpGeolocation SDK idempotency feature
...
class JsonIpGeolocationIdempotencyFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _mutating(JsonIpGeolocationContext $ctx): bool
    {
