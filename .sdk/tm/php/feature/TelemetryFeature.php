...
// JsonIpGeolocation SDK telemetry feature
...
class JsonIpGeolocationTelemetryFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _close(JsonIpGeolocationContext $ctx, bool $ok): void
    {
