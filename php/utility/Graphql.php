...
// JsonIpGeolocation SDK utility: graphql
//
...
class JsonIpGeolocationGraphql
{
    ...
    // equivalent.
    public static function body(JsonIpGeolocationContext $ctx): mixed
    {
    ...
    public static function errors(JsonIpGeolocationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
