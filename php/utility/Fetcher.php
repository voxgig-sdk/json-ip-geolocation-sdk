...
// JsonIpGeolocation SDK utility: fetcher

class JsonIpGeolocationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JsonIpGeolocationSDK/1.0)';
    ...
    public static function call(JsonIpGeolocationContext $ctx, string $fullurl, array $fetchdef): array
    {
