...
class JsongpEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set JSON_IP_GEOLOCATION_TEST_JSONGP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function jsongp_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("JSON_IP_GEOLOCATION_TEST_JSONGP_ENTID");
