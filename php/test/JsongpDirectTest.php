...
class JsongpDirectTest extends TestCase
{
    public function test_direct_load_jsongp(): void
    {
        $setup = jsongp_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-jsongp", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
