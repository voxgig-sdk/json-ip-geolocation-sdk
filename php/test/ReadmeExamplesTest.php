...
// JsonIpGeolocation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JsonIpGeolocationSDK::test)
...
{
    private const SDK_CLASS = 'JsonIpGeolocationSDK';
    ...
    private const SDK_BASE = 'jsonipgeolocation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../jsonipgeolocation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
