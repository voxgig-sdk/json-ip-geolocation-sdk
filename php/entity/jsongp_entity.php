...
// JsonIpGeolocation SDK Jsongp entity
...
class JsongpEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new JsongpEntity($this->_client, $opts);
    }

    /**
     * @param Jsongp|array $args Jsongp data (assoc-array) to store.
     */
    ...
    /**
     * @return Jsongp|array The current Jsongp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Jsongp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Jsongp fields).
     */
    ...
    /**
     * Load a single Jsongp.
     *
     * @param JsongpLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed JsongpLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Jsongp|array The loaded Jsongp as an assoc-array at the
