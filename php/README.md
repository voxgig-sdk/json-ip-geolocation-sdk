...
The PHP SDK for the JsonIpGeolocation API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Currencygp(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->JsonIpGeolocation(null)->load(
    ["id" => "test01"], null
);
