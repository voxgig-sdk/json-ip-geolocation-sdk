...
// JsonIpGeolocation SDK utility type

class JsonIpGeolocationUtility
{
    ...
    public static function copy(JsonIpGeolocationUtility $src): JsonIpGeolocationUtility
    {
        $u = new JsonIpGeolocationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
