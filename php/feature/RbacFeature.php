...
// JsonIpGeolocation SDK rbac feature
...
class JsonIpGeolocationRbacFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _required(JsonIpGeolocationContext $ctx): ?string
    {
    ...
    private function _reject(JsonIpGeolocationContext $ctx, string $required): void
    {
    ...
    private function _track(JsonIpGeolocationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
