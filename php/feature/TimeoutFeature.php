...
// JsonIpGeolocation SDK timeout feature
...
class JsonIpGeolocationTimeoutFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _with_timeout(JsonIpGeolocationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JsonIpGeolocationContext $_ctx, float $ms): void
    {
        $client = $this->client;
