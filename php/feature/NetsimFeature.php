...
// JsonIpGeolocation SDK netsim feature
...
class JsonIpGeolocationNetsimFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _simulate(JsonIpGeolocationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(JsonIpGeolocationContext $ctx, array $applied): void
    {
        $client = $this->client;
