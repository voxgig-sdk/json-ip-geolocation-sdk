...
// JsonIpGeolocation SDK proxy feature
...
class JsonIpGeolocationProxyFeature extends JsonIpGeolocationBaseFeature
{
    ...
    public function init(JsonIpGeolocationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (JsonIpGeolocationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
