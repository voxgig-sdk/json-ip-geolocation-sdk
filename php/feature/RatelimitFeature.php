...
// JsonIpGeolocation SDK ratelimit feature
...
class JsonIpGeolocationRatelimitFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _acquire(JsonIpGeolocationContext $ctx): void
    {
    ...
    private function _track(JsonIpGeolocationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
