...
// JsonIpGeolocation SDK streaming feature
...
class JsonIpGeolocationStreamingFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _iterate(JsonIpGeolocationResult $result): \Generator
    {
    ...
    private function _streamable(JsonIpGeolocationContext $ctx): bool
    {
