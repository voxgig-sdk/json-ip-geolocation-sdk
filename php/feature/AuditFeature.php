...
// JsonIpGeolocation SDK audit feature
...
class JsonIpGeolocationAuditFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _emit(JsonIpGeolocationContext $ctx, string $outcome): void
    {
