...
// JsonIpGeolocation SDK paging feature
...
class JsonIpGeolocationPagingFeature extends JsonIpGeolocationBaseFeature
{
    ...
    private function _is_list(JsonIpGeolocationContext $ctx): bool
    {
