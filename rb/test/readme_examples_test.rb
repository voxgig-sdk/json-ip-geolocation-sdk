...
#      offline in seeded test mode (JsonIpGeolocationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "JsonIpGeolocation_sdk.rb")
  SDK_CLASS = "JsonIpGeolocationSDK"
  ...
  SDK_BASE = "JsonIpGeolocation_sdk"
