...
function runner.env_override(m)
  local live = runner.getenv("JSON_IP_GEOLOCATION_TEST_LIVE")
  local override = runner.getenv("JSON_IP_GEOLOCATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("JSON_IP_GEOLOCATION_TEST_EXPLAIN")
