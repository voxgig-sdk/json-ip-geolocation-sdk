...
describe("JsongpDirect", function()
  it("should direct-load-jsongp", function()
    local setup = jsongp_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-jsongp", setup.live and "live" or "unit")
...
function jsongp_direct_setup(mockres)
