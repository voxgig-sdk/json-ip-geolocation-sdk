...
function CurrencygpEntity:mark_deleted()
  self._deleted = true
end


function CurrencygpEntity:deleted()
...
function CurrencygpEntity:stream(action, args, callopts)
...
---@param reqmatch CurrencygpLoadMatch
---@param ctrl? table
---@return Currencygp
---@return string? err
