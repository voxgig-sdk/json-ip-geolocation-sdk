// Command JsonIpGeolocation-mcp is an MCP server exposing the JsonIpGeolocation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	JsonIpGeolocation_list  — list records of an entity
//	JsonIpGeolocation_load  — load a single record of an entity
//
