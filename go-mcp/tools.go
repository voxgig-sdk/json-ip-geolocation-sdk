...
type Args struct {
	Entity string         `json:"entity" jsonschema:"currencygp | jsongp"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.JsonIpGeolocationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "json-ip-geolocation_list",
		Description: "List records from JsonIpGeolocation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "json-ip-geolocation_load",
		Description: "Load a single record from JsonIpGeolocation. " +
...
func runOp(client *sdk.JsonIpGeolocationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.JsonIpGeolocationSDK, name string) (sdk.JsonIpGeolocationEntity, error) {
	switch strings.ToLower(name) {
	case "currencygp":
		return client.Currencygp(nil), nil
	case "jsongp":
		return client.Jsongp(nil), nil
