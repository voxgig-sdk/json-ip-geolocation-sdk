...
from jsonipgeolocation_sdk.utility.voxgig_struct import voxgig_struct as vs
from jsonipgeolocation_sdk import JsonIpGeolocationSDK
from jsonipgeolocation_sdk.core.spec import JsonIpGeolocationSpec
from jsonipgeolocation_sdk.core.result import JsonIpGeolocationResult
from jsonipgeolocation_sdk.core.response import JsonIpGeolocationResponse
from jsonipgeolocation_sdk.core.operation import JsonIpGeolocationOperation
from jsonipgeolocation_sdk.core.error import JsonIpGeolocationError
from jsonipgeolocation_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return JsonIpGeolocationError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except JsonIpGeolocationError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = JsonIpGeolocationResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = JsonIpGeolocationSDK.test(None, None)
        ...
        class TestInitFeature(JsonIpGeolocationBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(JsonIpGeolocationBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = JsonIpGeolocationSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = JsonIpGeolocationSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = JsonIpGeolocationSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = JsonIpGeolocationSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = JsonIpGeolocationSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = JsonIpGeolocationOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = JsonIpGeolocationSDK.test(None, setup_opts)
