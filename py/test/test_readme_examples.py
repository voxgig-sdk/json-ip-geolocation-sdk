# JsonIpGeolocation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JsonIpGeolocationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JsonIpGeolocationSDK(...) and JsonIpGeolocationSDK.test(...) become
#      JsonIpGeolocationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "jsonipgeolocation_sdk"
_SDK_CLASS = "JsonIpGeolocationSDK"
