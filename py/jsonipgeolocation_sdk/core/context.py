...
from jsonipgeolocation_sdk.core.control import JsonIpGeolocationControl
...
from jsonipgeolocation_sdk.core.helpers import get_ctx_prop, to_map
...
class JsonIpGeolocationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = JsonIpGeolocationControl()
        ...
        if isinstance(sp, JsonIpGeolocationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, JsonIpGeolocationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, JsonIpGeolocationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return JsonIpGeolocationOperation({})
    ...
    def make_error(self, code, msg):
        return JsonIpGeolocationError(code, msg, self)
