...
from jsonipgeolocation_sdk.utility import register

# Load features
from jsonipgeolocation_sdk.feature.base_feature import JsonIpGeolocationBaseFeature
from jsonipgeolocation_sdk.features import _has_feature, _make_feature
...
class JsonIpGeolocationSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = JsonIpGeolocationUtility()
        self._utility = utility

        from jsonipgeolocation_sdk.config import shared_config
    ...
    def get_utility(self):
        return JsonIpGeolocationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JsonIpGeolocationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Currencygp(self, data=None) -> "CurrencygpEntity":
        ...
        from jsonipgeolocation_sdk.entity.currencygp_entity import CurrencygpEntity
    ...
    def Jsongp(self, data=None) -> "JsongpEntity":
        ...
        from jsonipgeolocation_sdk.entity.jsongp_entity import JsongpEntity
