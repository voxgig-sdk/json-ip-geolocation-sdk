...
func registerSDKWords(r *eng.Registry, client *sdk.JsonIpGeolocationSDK) {
...
func runOp(client *sdk.JsonIpGeolocationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
