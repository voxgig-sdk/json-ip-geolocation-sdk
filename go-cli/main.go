// Command JsonIpGeolocation-cli is a CLI + REPL for the JsonIpGeolocation SDK,
...
const prompt = "json-ip-geolocation"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "currencygp jsongp"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      JSON_IP_GEOLOCATION_APIKEY (api key), JSON_IP_GEOLOCATION_BASE (base url override)")
