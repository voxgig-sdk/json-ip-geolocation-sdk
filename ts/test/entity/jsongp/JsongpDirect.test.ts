...
describe('JsongpDirect', async () => {
  ...
  test('direct-load-jsongp', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-jsongp', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['JSON_IP_GEOLOCATION_TEST_JSONGP_ENTID']
