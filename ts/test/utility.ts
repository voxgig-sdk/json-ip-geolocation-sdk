...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.JSONIPGEOLOCATION_TEST_LIVE ||
    'TRUE' === process.env.JSONIPGEOLOCATION_TEST_OVERRIDE
  ) {
  ...
  m.JSONIPGEOLOCATION_TEST_EXPLAIN = process.env.JSONIPGEOLOCATION_TEST_EXPLAIN || m.JSONIPGEOLOCATION_TEST_EXPLAIN
