...
(0, node_test_1.describe)('JsongpDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-jsongp', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-jsongp', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JSON_IP_GEOLOCATION_TEST_JSONGP_ENTID'];
...
//# sourceMappingURL=JsongpDirect.test.js.map