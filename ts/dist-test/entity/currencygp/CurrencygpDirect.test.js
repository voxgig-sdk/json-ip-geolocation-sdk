...
(0, node_test_1.describe)('CurrencygpDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.JsonIpGeolocationSDK({
    ...
    (0, node_test_1.test)('direct-load-currencygp', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-currencygp', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.JsonIpGeolocationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['JSON_IP_GEOLOCATION_TEST_CURRENCYGP_ENTID'];
    ...
    const client = new __1.JsonIpGeolocationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CurrencygpDirect.test.js.map