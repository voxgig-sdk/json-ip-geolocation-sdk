...
function envOverride(m) {
    if ('TRUE' === process.env.JSON_IP_GEOLOCATION_TEST_LIVE ||
        'TRUE' === process.env.JSON_IP_GEOLOCATION_TEST_OVERRIDE) {
    ...
    m.JSON_IP_GEOLOCATION_TEST_EXPLAIN = process.env.JSON_IP_GEOLOCATION_TEST_EXPLAIN || m.JSON_IP_GEOLOCATION_TEST_EXPLAIN;
    return m;
}
