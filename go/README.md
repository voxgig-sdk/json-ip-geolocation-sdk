...
The Golang SDK for the JsonIpGeolocation API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/json-ip-geolocation-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/json-ip-geolocation-sdk=../path/to/github.com/voxgig-sdk/json-ip-geolocation-sdk
```
...
```
github.com/voxgig-sdk/json-ip-geolocation-sdk/
...
The root package (`github.com/voxgig-sdk/json-ip-geolocation-sdk`) re-exports everything needed
