...
type JsonIpGeolocationSDK struct {
	Mode     string
...
func (sdk *JsonIpGeolocationSDK) OptionsMap() map[string]any {
...
func (sdk *JsonIpGeolocationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *JsonIpGeolocationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *JsonIpGeolocationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JsonIpGeolocationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *JsonIpGeolocationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *JsonIpGeolocationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("JsonIpGeolocationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *JsonIpGeolocationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JsonIpGeolocationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("JsonIpGeolocationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *JsonIpGeolocationSDK {
	...
	sdk := NewJsonIpGeolocationSDK(sdkopts)
	sdk.Mode = "test"
