...
import (
	...
	"github.com/voxgig-sdk/json-ip-geolocation-sdk/go/entity"
	"github.com/voxgig-sdk/json-ip-geolocation-sdk/go/feature"
	_ "github.com/voxgig-sdk/json-ip-geolocation-sdk/go/utility"
)
...
// instead of `sdk.NewJsonIpGeolocationSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *JsonIpGeolocationSDK  { return NewJsonIpGeolocationSDK(nil) }
func Test() *JsonIpGeolocationSDK { return TestSDK(nil, nil) }
