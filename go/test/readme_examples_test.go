...
const testSeed = `map[string]any{"entity": map[string]any{"currencygp": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "jsongp": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
