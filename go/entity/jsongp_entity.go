...
type JsongpEntity struct {
	name    string
	client  *core.JsonIpGeolocationSDK
...
func NewJsongpEntity(client *core.JsonIpGeolocationSDK, entopts map[string]any) *JsongpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *JsongpEntity) GetName() string { return e.name }
...
func (e *JsongpEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *JsongpEntity) Deleted() bool {
	return e.deleted
}


func (e *JsongpEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewJsongpEntity(e.client, opts)
}

func (e *JsongpEntity) Data(args ...any) any {
...
func (e *JsongpEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Jsongp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *JsongpEntity) DataTyped(data ...Jsongp) Jsongp {
	if len(data) > 0 {
		return typedFrom[Jsongp](e.Data(asMap(data[0])))
	}
	return typedFrom[Jsongp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Jsongp (all fields
// optional at the wire level).
func (e *JsongpEntity) MatchTyped(match ...Jsongp) Jsongp {
	if len(match) > 0 {
		return typedFrom[Jsongp](e.Match(asMap(match[0])))
	}
	return typedFrom[Jsongp](e.Match())
}
...
func (e *JsongpEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *JsongpEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// JsongpLoadMatch and returns an Jsongp. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *JsongpEntity) LoadTyped(reqmatch JsongpLoadMatch, ctrl map[string]any) (Jsongp, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Jsongp{}, err
	}
	return typedFrom[Jsongp](res), nil
}



func (e *JsongpEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *JsongpEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *JsongpEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *JsongpEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *JsongpEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
