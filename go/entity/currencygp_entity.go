...
func NewCurrencygpEntity(client *core.JsonIpGeolocationSDK, entopts map[string]any) *CurrencygpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CurrencygpEntity) GetName() string { return e.name }
...
func (e *CurrencygpEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CurrencygpEntity) Deleted() bool {
	return e.deleted
}


func (e *CurrencygpEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCurrencygpEntity(e.client, opts)
}

func (e *CurrencygpEntity) Data(args ...any) any {
...
func (e *CurrencygpEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CurrencygpEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CurrencygpEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CurrencygpEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CurrencygpEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CurrencygpEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CurrencygpEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
